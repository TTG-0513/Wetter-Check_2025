...
import 'dart:convert';
import 'package:wetter_check_2025/widgets/button_line3.dart';

class WetterLeipzig extends StatefulWidget {
  const WetterLeipzig({super.key});

  @override
  State<WetterLeipzig> createState() => _WetterCheckState();
}

class _WetterCheckState extends State<WetterLeipzig> {
  String klima = "";
  String klima2 = "";
  String klima3 = "";
  String klima4 = "";
  ...
  fetchKlima() async {
    final response = await http.get(Uri.parse(
        "https://api.open-meteo.com/v1/forecast?latitude=51.3396&longitude=12.3713&hourly=temperature_2m,wind_speed_10m&current=temperature_2m,cloud_cover,apparent_temperature,relative_humidity_2m,wind_speed_10m&timezone=Europe%2FBerlin&forecast_days=1"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Das Wetter in Leipzig"),
        actions: [
            ...
            child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    width: 300,
                    child: Image.network(
                        "https://images.unsplash.com/photo-1583602690006-31db03a8b86f?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
                  ),
                  Container(
                      height: 20,
                      width: 300,
